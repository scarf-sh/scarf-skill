...
Cover all operations in the published OpenAPI document at `https://api.scarf.sh/static/api-v2.yaml`, including its v2 and v3 paths. The 2026-09-24 snapshot contains 86 operations.
